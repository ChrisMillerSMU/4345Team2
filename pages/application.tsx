...
export default function applicationPage() {
  ...
  return (
    <>
      ...
      {/* Small Screen */}
      <section className="flex md:hidden min-h-screen h-viewport justify-center bg-black-200">
        <div className="flex flex-col items-center justify-center w-5/6 h-4/5 bg-black-200 my-8 p-6">
            <>
              {/* Main Application Screen */}
              <h1 className="text-3xl p-4 text-white font-black text-center">TA Application</h1> {/* !change */}
              {/* TA Application */}
              <div className="w-5/6">
                <form onSubmit={handleSubmit}>
                  <input
                  ...
                  <h1 className="font-bold text-white text-3xl p-4 mt-2 text-center">Known Languages</h1>
                  <hr className="mb-10 h-px bg-gray-500 border-0" />
                  <div className="ml-3">
                    <div className="form-check text-left">
                      <input 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="Java-checkbox" className="ml-2 text-sm font-medium text-white">Java</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="C-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="C-checkbox" className="ml-2 text-sm font-medium text-white">C++</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="Python-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="Python-checkbox" className="ml-2 text-sm font-medium text-white">Python</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="JavaScript-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="JavaScript-checkbox" className="ml-2 text-sm font-medium text-white">JavaScript</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="SQL-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="SQL-checkbox" className="ml-2 text-sm font-medium text-white">SQL</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="MATLAB-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="MATLAB-checkbox" className="ml-2 text-sm font-medium text-white">MATLAB</label>
                    </div>
                  </div>
                  <div className="text-center mt-4 mb-5">
                    <input
                  ...
                  {/* Core Classes */}
                  <h1 className="font-bold text-white text-3xl p-4 mt-2 text-center">Core Classes Taken</h1>
                  <hr className="mb-10 h-px bg-gray-500 border-0" />
                  <div className="ml-3">
                    <div className="form-check">
                      <input 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS1341-checkbox" className="ml-2 text-sm font-medium text-white">CS 1341</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS1342-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS1342-checkbox" className="ml-2 text-sm font-medium text-white">CS 1342</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS2240-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS2240-checkbox" className="ml-2 text-sm font-medium text-white">CS 2240</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS2341-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS2341-checkbox" className="ml-2 text-sm font-medium text-white">CS 2341</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS3330-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS3330-checkbox" className="ml-2 text-sm font-medium text-white">CS 3330</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS3339-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS3339-checkbox" className="ml-2 text-sm font-medium text-white">CS 3339</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS3342-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS3342-checkbox" className="ml-2 text-sm font-medium text-white">CS 3342</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS3345-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS3345-checkbox" className="ml-2 text-sm font-medium text-white">CS 3345</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS3353-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS3353-checkbox" className="ml-2 text-sm font-medium text-white">CS 3353</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS3381-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS3381-checkbox" className="ml-2 text-sm font-medium text-white">CS 3381</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS4344-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS4344-checkbox" className="ml-2 text-sm font-medium text-white">CS 4344</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS4345-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS4345-checkbox" className="ml-2 text-sm font-medium text-white">CS 4345</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS4351-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS4351-checkbox" className="ml-2 text-sm font-medium text-white">CS 4351</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS4352-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS4352-checkbox" className="ml-2 text-sm font-medium text-white">CS 4352</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS4381-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS4381-checkbox" className="ml-2 text-sm font-medium text-white">CS 4381</label>
                    </div>
                    <div className="form-check">
                      <input 
                        id="CS5343-checkbox" 
                        ...
                        className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      />
                      <label htmlFor="CS5343-checkbox" className="ml-2 text-sm font-medium text-white">CS 5343</label>
                    </div>
                  </div>
                  <div className="text-center mt-4 mb-5">
                    <input
